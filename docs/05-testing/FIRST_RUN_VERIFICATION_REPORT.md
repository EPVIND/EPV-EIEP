...
|---|---|---|
| `pnpm run verify` | Passed | Production/training boundary, secret scan, 40/25 requirement traceability, generated OpenAPI drift, 11 Bicep templates, strict TypeScript, 73 unit/integration/security/acceptance tests |
