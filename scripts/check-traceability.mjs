...
if (controlledSet.size !== 86) failures.push(`expected 86 controlled requirements, found ${controlledSet.size}`);
if (mappedSet.size !== 86) failures.push(`expected 86 mapped requirements, found ${mappedSet.size}`);
