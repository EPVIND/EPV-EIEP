...
if (controlledSet.size !== 75) failures.push(`expected 75 controlled requirements, found ${controlledSet.size}`);
if (mappedSet.size !== 75) failures.push(`expected 75 mapped requirements, found ${mappedSet.size}`);
