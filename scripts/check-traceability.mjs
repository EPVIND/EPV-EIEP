...
if (controlledSet.size !== 115) failures.push(`expected 115 controlled requirements, found ${controlledSet.size}`);
if (mappedSet.size !== 115) failures.push(`expected 115 mapped requirements, found ${mappedSet.size}`);
