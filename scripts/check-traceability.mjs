...
if (controlledSet.size !== 94) failures.push(`expected 94 controlled requirements, found ${controlledSet.size}`);
if (mappedSet.size !== 94) failures.push(`expected 94 mapped requirements, found ${mappedSet.size}`);
