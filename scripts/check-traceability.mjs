...
if (controlledSet.size !== 121) failures.push(`expected 121 controlled requirements, found ${controlledSet.size}`);
if (mappedSet.size !== 121) failures.push(`expected 121 mapped requirements, found ${mappedSet.size}`);
