...
if (controlledSet.size !== 109) failures.push(`expected 109 controlled requirements, found ${controlledSet.size}`);
if (mappedSet.size !== 109) failures.push(`expected 109 mapped requirements, found ${mappedSet.size}`);
